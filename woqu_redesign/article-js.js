...
window.onload = function(){
	...
	var aSort = [];
	var aPosition = [
					{width:500,height:350,top:52,left:280,zIndex:10},
					{width:260,height:332,top:61,left:148,zIndex:8},
					{width:204,height:260,top:98,left:0,zIndex:6},
					...
					{width:204,height:260,top:98,left:844,zIndex:6},
					{width:260,height:332,top:61,left:640,zIndex:8}
		]
...
$(function(){
	$('.titleNusa li:last').css('color','#0AAA96');
	$('.Indetail-tips li:last').css('border-right','none');
	$('.eatting li:odd').css('margin', '0 20px 0');
});